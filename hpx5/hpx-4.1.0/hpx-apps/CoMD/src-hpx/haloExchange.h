...
//type of the haloexchange this is to be used in recv_action
//when the packet arrives it needs to know which one it is
// so the packet will carry this information
#define FORCE 0
#define ATOM 1
...
void haloExchange(HaloExchange* haloExchange, void* data, void *sim);
