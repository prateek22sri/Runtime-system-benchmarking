...
#  runs the ss solver on instances in the Square-C family

#  Usage: > perl runSquare-C.ss.pl
# ============================================================================
...
$RESFILE   = "../results/Square-C.ss.res";
$PREFIX    = "$ARGV[0]/inputs/Square-C/Square-C";
$SOLVER    = "../sssp";
$GRAPH     = "$PREFIX.%s.%s.gr";
$AUX       = "$PREFIX.%s.%s.ss";
...
print   "* Square-C family ss core experiment\n";
