...
/* ---------------- method closures -------------- */
    ...
    struct Closure_SSSPVertex::process_4_closure : public SDAG::Closure {
      dtype m;
      ...
      process_4_closure(CkMigrateMessage*) {
        init();
      }
      dtype & getP0() { return m;}
      void pup(PUP::er& __p) {
        __p | m;
        packClosure(__p);
      }
      virtual ~process_4_closure() {
      }
      PUPable_decl(SINGLE_ARG(process_4_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_SSSPVertex::update_5_closure : public SDAG::Closure {
      dtype m;
      ...
      update_5_closure(CkMigrateMessage*) {
        init();
      }
      dtype & getP0() { return m;}
      void pup(PUP::er& __p) {
      ...
      virtual ~update_5_closure() {
      }
      PUPable_decl(SINGLE_ARG(update_5_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
    ...
    struct Closure_SSSPVertex::verify_7_closure : public SDAG::Closure {
      

      verify_7_closure() {
        init();
      }
      verify_7_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~verify_7_closure() {
      }
      PUPable_decl(SINGLE_ARG(verify_7_closure));
    };
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY

    struct Closure_SSSPVertex::check_8_closure : public SDAG::Closure {
      double w;
    ...
    struct Closure_SSSPVertex::print_9_closure : public SDAG::Closure {
      

      print_9_closure() {
        init();
      }
      print_9_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~print_9_closure() {
      }
      PUPable_decl(SINGLE_ARG(print_9_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
/* DEFS: readonly CProxy_ArrayMeshStreamer<dtype,long long,SSSPVertex,SimpleMeshRouter > aggregator;
 */
extern CProxy_ArrayMeshStreamer<dtype,long long,SSSPVertex,SimpleMeshRouter > aggregator;
#ifndef CK_TEMPLATES_ONLY
...
void make_root(void);
threaded void process(const dtype &m);
threaded void update(const dtype &m);
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: threaded void process(const dtype &m);
 */

void CProxyElement_SSSPVertex::process(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
  { //Find the size of the PUP'd data
    PUP::sizer implP;
    //Have to cast away const-ness to get pup routine
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_SSSPVertex::idx_process_marshall4(),0);
}
#endif /* CK_TEMPLATES_ONLY */

#ifndef CK_TEMPLATES_ONLY
/* DEFS: threaded void update(const dtype &m);
 */

void CProxyElement_SSSPVertex::update(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_SSSPVertex::idx_update_marshall5(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_SSSPVertex::check(const double &w, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_SSSPVertex::idx_check_marshall8(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_SSSPVertex::process(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_SSSPVertex::idx_process_marshall4(),0);
}

// Entry point registration function

int CkIndex_SSSPVertex::reg_process_marshall4() {
  int epidx = CkRegisterEp("process(const dtype &m)",
      _call_process_marshall4, CkMarshallMsg::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_process_marshall4);

  return epidx;
}


void CkIndex_SSSPVertex::_call_process_marshall4(void* impl_msg, void* impl_obj_void)
{
  SSSPVertex* impl_obj = static_cast<SSSPVertex *>(impl_obj_void);
  CthThread tid = CthCreate((CthVoidFn)_callthr_process_marshall4, new CkThrCallArg(impl_msg,impl_obj), 0);
  ((Chare *)impl_obj)->CkAddThreadListeners(tid,impl_msg);
  CthResume(tid);
}

void CkIndex_SSSPVertex::_callthr_process_marshall4(CkThrCallArg *impl_arg)
{
  void *impl_msg = impl_arg->msg;
  SSSPVertex *impl_obj = (SSSPVertex *) impl_arg->obj;
  delete impl_arg;
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const dtype &m*/
  PUP::fromMem implP(impl_buf);
  dtype m; implP|m;
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
...
void CkIndex_SSSPVertex::_marshallmessagepup_process_marshall4(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const dtype &m*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_SSSPVertex::process_4_closure));
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_SSSPVertex::update(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_SSSPVertex::idx_update_marshall5(),0);
}

// Entry point registration function

int CkIndex_SSSPVertex::reg_update_marshall5() {
  int epidx = CkRegisterEp("update(const dtype &m)",
      _call_update_marshall5, CkMarshallMsg::__idx, __idx, 0);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_update_marshall5);

  return epidx;
}


void CkIndex_SSSPVertex::_call_update_marshall5(void* impl_msg, void* impl_obj_void)
{
  SSSPVertex* impl_obj = static_cast<SSSPVertex *>(impl_obj_void);
  CthThread tid = CthCreate((CthVoidFn)_callthr_update_marshall5, new CkThrCallArg(impl_msg,impl_obj), 0);
  ((Chare *)impl_obj)->CkAddThreadListeners(tid,impl_msg);
  CthResume(tid);
}

void CkIndex_SSSPVertex::_callthr_update_marshall5(CkThrCallArg *impl_arg)
{
  void *impl_msg = impl_arg->msg;
  SSSPVertex *impl_obj = (SSSPVertex *) impl_arg->obj;
  delete impl_arg;
...
void CkIndex_SSSPVertex::_marshallmessagepup_update_marshall5(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const dtype &m*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_SSSPVertex::update_5_closure));
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_SSSPVertex::verify_7_closure));
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_SSSPVertex::check(const double &w, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_SSSPVertex::idx_check_marshall8(),0);
}

// Entry point registration function

int CkIndex_SSSPVertex::reg_check_marshall8() {
...
void CkIndex_SSSPVertex::_call_check_marshall8(void* impl_msg, void* impl_obj_void)
{
  SSSPVertex* impl_obj = static_cast<SSSPVertex *>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_SSSPVertex::_callmarshall_check_marshall8(char* impl_buf, void* impl_obj_void) {
  SSSPVertex* impl_obj = static_cast< SSSPVertex *>(impl_obj_void);
  /*Unmarshall pup'd fields: const double &w*/
  PUP::fromMem implP(impl_buf);
  double w; implP|w;
...
void CkIndex_SSSPVertex::_marshallmessagepup_check_marshall8(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const double &w*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_SSSPVertex::check_8_closure));
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_SSSPVertex::print_9_closure));
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_SSSPVertex::process(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
...
void CProxySection_SSSPVertex::update(const dtype &m, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const dtype &m
  int impl_off=0;
...
void CkIndex_SSSPVertex::__register(const char *s, size_t size) {
  ...
  // REG: threaded void process(const dtype &m);
  idx_process_marshall4();

  // REG: threaded void update(const dtype &m);
  idx_update_marshall5();
...
void _registertram_sssp(void)
{
  ...
  CkRegisterReadonly("aggregator","CProxy_ArrayMeshStreamer<dtype,long long,SSSPVertex,SimpleMeshRouter >",sizeof(aggregator),(void *) &aggregator,__xlater_roPup_aggregator);
