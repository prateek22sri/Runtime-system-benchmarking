...
void ParamList::print(XStr &str,int withDefaultValues,int useConst, int useRef, char delim)
{
...
void Parameter::print(XStr &str,int withDefaultValues,int useConst, int useRef)
{
	if (arrLen!=NULL)
...
void ParamList::printName(XStr &str)
{
    	param->printName(str);
    	if (next) {
    		str<<", ";
...
void Parameter::printName(XStr &str)
{
	if (name) str<<name;
}
