#ifndef _DECL_charm_bfs_H_
#define _DECL_charm_bfs_H_
#include "charm++.h"
#include "envelope.h"
#include <memory>
#include "sdag.h"
...
/* DECLS: array BFSVertex: ArrayElement{
BFSVertex(void);
 ...
 */
 class BFSVertex;
 class CkIndex_BFSVertex;
 class CProxy_BFSVertex;
 class CProxyElement_BFSVertex;
 class CProxySection_BFSVertex;
/* --------------- index object ------------------ */
class CkIndex_BFSVertex:public CkIndex_ArrayElement{
  public:
    typedef BFSVertex local_t;
    typedef CkIndex_BFSVertex index_t;
    typedef CProxy_BFSVertex proxy_t;
    typedef CProxyElement_BFSVertex element_t;
    typedef CProxySection_BFSVertex section_t;

    static int __idx;
    static void __register(const char *s, size_t size);
    /* DECLS: BFSVertex(void);
     */
    // Entry point registration at startup
    
    static int reg_BFSVertex_void();
    // Entry point index lookup
    
    inline static int idx_BFSVertex_void() {
      static int epidx = reg_BFSVertex_void();
      return epidx;
    }

    
    static int ckNew(void) { return idx_BFSVertex_void(); }
    
    static void _call_BFSVertex_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_BFSVertex_void(void* impl_msg, void* impl_obj);
    /* DECLS: void connectVertex(const BFSEdge &edge);
     */
    // Entry point registration at startup
    ...
    inline static int idx_connectVertex(void (BFSVertex::*)(const BFSEdge &edge) ) {
      return idx_connectVertex_marshall2();
    }


    
    static int connectVertex(const BFSEdge &edge) { return idx_connectVertex_marshall2(); }
    ...
    inline static int idx_make_root(void (BFSVertex::*)(void) ) {
    ...
    /* DECLS: void update(int level, const CmiUInt8 &parent);
     */
    // Entry point registration at startup
    ...
    inline static int idx_update(void (BFSVertex::*)(int level, const CmiUInt8 &parent) ) {
      return idx_update_marshall4();
    }


    
    static int update(int level, const CmiUInt8 &parent) { return idx_update_marshall4(); }
    ...
    inline static int idx_getScannedVertexNum(void (BFSVertex::*)(void) ) {
    ...
    inline static int idx_verify(void (BFSVertex::*)(void) ) {
    ...
    inline static int idx_check(void (BFSVertex::*)(int level) ) {
      return idx_check_marshall7();
    }


    
    static int check(int level) { return idx_check_marshall7(); }
    ...
    inline static int idx_dump_edges(void (BFSVertex::*)(void) ) {
    ...
    /* DECLS: BFSVertex(CkMigrateMessage* impl_msg);
     */
    // Entry point registration at startup
    
    static int reg_BFSVertex_CkMigrateMessage();
    // Entry point index lookup
    
    inline static int idx_BFSVertex_CkMigrateMessage() {
      static int epidx = reg_BFSVertex_CkMigrateMessage();
      return epidx;
    }

    
    static int ckNew(CkMigrateMessage* impl_msg) { return idx_BFSVertex_CkMigrateMessage(); }
    
    static void _call_BFSVertex_CkMigrateMessage(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_BFSVertex_CkMigrateMessage(void* impl_msg, void* impl_obj);
};
/* --------------- element proxy ------------------ */
 class CProxyElement_BFSVertex : public CProxyElement_ArrayElement{
  public:
    typedef BFSVertex local_t;
    typedef CkIndex_BFSVertex index_t;
    typedef CProxy_BFSVertex proxy_t;
    ...
    CProxyElement_BFSVertex(void) {}
    CProxyElement_BFSVertex(const ArrayElement *e) : CProxyElement_ArrayElement(e){  }
    ...
    BFSVertex *ckLocal(void) const
    { return (BFSVertex *)CProxyElement_ArrayElement::ckLocal(); }

    CProxyElement_BFSVertex(const CkArrayID &aid,const CkArrayIndex1D &idx,CK_DELCTOR_PARAM)
        :CProxyElement_ArrayElement(aid,idx,CK_DELCTOR_ARGS)
    {}
    CProxyElement_BFSVertex(const CkArrayID &aid,const CkArrayIndex1D &idx)
        :CProxyElement_ArrayElement(aid,idx)
    {}

    CProxyElement_BFSVertex(const CkArrayID &aid,const CkArrayIndex &idx,CK_DELCTOR_PARAM)
        :CProxyElement_ArrayElement(aid,idx,CK_DELCTOR_ARGS)
    {}
    CProxyElement_BFSVertex(const CkArrayID &aid,const CkArrayIndex &idx)
        :CProxyElement_ArrayElement(aid,idx)
    {}
/* DECLS: BFSVertex(void);
 */
 ...
 */
    ...
    void connectVertex(const BFSEdge &edge, const CkEntryOptions *impl_e_opts=NULL) ;
 ...
 */
    ...
    void update(int level, const CmiUInt8 &parent, const CkEntryOptions *impl_e_opts=NULL) ;
 ...
 */
    ...
    void check(int level, const CkEntryOptions *impl_e_opts=NULL) ;
...
PUPmarshall(CProxyElement_BFSVertex)
/* ---------------- collective proxy -------------- */
 class CProxy_BFSVertex : public CProxy_ArrayElement{
  public:
    typedef BFSVertex local_t;
    typedef CkIndex_BFSVertex index_t;
    typedef CProxy_BFSVertex proxy_t;
    ...
    CProxy_BFSVertex(void) {}
    CProxy_BFSVertex(const ArrayElement *e) : CProxy_ArrayElement(e){  }
    ...
    CProxyElement_BFSVertex operator [] (const CkArrayIndex1D &idx) const
    { return CProxyElement_BFSVertex(ckGetArrayID(), idx, CK_DELCTOR_CALL); }
    CProxyElement_BFSVertex operator() (const CkArrayIndex1D &idx) const
    { return CProxyElement_BFSVertex(ckGetArrayID(), idx, CK_DELCTOR_CALL); }
    CProxyElement_BFSVertex operator [] (int idx) const 
        {return CProxyElement_BFSVertex(ckGetArrayID(), CkArrayIndex1D(idx), CK_DELCTOR_CALL);}
    CProxyElement_BFSVertex operator () (int idx) const 
        {return CProxyElement_BFSVertex(ckGetArrayID(), CkArrayIndex1D(idx), CK_DELCTOR_CALL);}
    CProxy_BFSVertex(const CkArrayID &aid,CK_DELCTOR_PARAM) 
        :CProxy_ArrayElement(aid,CK_DELCTOR_ARGS) {}
    CProxy_BFSVertex(const CkArrayID &aid) 
...
PUPmarshall(CProxy_BFSVertex)
/* ---------------- section proxy -------------- */
 class CProxySection_BFSVertex : public CProxySection_ArrayElement{
  public:
    typedef BFSVertex local_t;
    typedef CkIndex_BFSVertex index_t;
    typedef CProxy_BFSVertex proxy_t;
    ...
    CProxyElement_BFSVertex operator() (const CkArrayIndex1D &idx) const
        {return CProxyElement_BFSVertex(ckGetArrayID(), idx, CK_DELCTOR_CALL);}
    CProxyElement_BFSVertex operator [] (int idx) const 
        {return CProxyElement_BFSVertex(ckGetArrayID(), *(CkArrayIndex1D*)&ckGetArrayElements()[idx], CK_DELCTOR_CALL);}
    CProxyElement_BFSVertex operator () (int idx) const 
        {return CProxyElement_BFSVertex(ckGetArrayID(), *(CkArrayIndex1D*)&ckGetArrayElements()[idx], CK_DELCTOR_CALL);}
    ...
    CProxySection_BFSVertex(const CkArrayID &aid, CkArrayIndex *elems, int nElems, CK_DELCTOR_PARAM) 
        :CProxySection_ArrayElement(aid,elems,nElems,CK_DELCTOR_ARGS) {}
    CProxySection_BFSVertex(const CkArrayID &aid, CkArrayIndex *elems, int nElems) 
        :CProxySection_ArrayElement(aid,elems,nElems) {}
    CProxySection_BFSVertex(const CkSectionID &sid)       :CProxySection_ArrayElement(sid) {}
    CProxySection_BFSVertex(int n, const CkArrayID *aid, CkArrayIndex const * const *elems, const int *nElems, CK_DELCTOR_PARAM) 
        :CProxySection_ArrayElement(n,aid,elems,nElems,CK_DELCTOR_ARGS) {}
    CProxySection_BFSVertex(int n, const CkArrayID *aid, CkArrayIndex const * const *elems, const int *nElems) 
...
PUPmarshall(CProxySection_BFSVertex)
#define BFSVertex_SDAG_CODE 
typedef CBaseT1<ArrayElementT<CkIndex1D>, CProxy_BFSVertex>CBase_BFSVertex;
...
class Closure_BFSVertex {
  public:
    ...
    struct getScannedVertexNum_5_closure;


    struct verify_6_closure;


    struct check_7_closure;


    struct dump_edges_8_closure;
...
extern void _registercharm_bfs(void);
