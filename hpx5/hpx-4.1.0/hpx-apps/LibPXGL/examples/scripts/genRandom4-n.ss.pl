...
#  Random sources generator for the Random4-n family
#  Creates a suite of single-source shortest path
#  problem-specific auxiliary files.

#  Usage: > perl genRandom4-n.ss.pl
# ============================================================================
...
$FORMAT  = "$DIR/Random4-n.%s.%s.ss";


# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Random sources generator for the Random4-n family\n";
...
for ( $p = $START; $p < $END + 1 ; $p++ ) { 
    ...
    for ( $trial = 0; $trial < $TRIALS; ++$trial) {
        ...
        print FILE "c Random4-n family ss problem instance\n";
        print FILE "c\n";
