#ifndef _DECL_tram_sssp_H_
#define _DECL_tram_sssp_H_
#include "charm++.h"
#include "envelope.h"
#include <memory>
#include "sdag.h"
...
/* DECLS: readonly CProxy_ArrayMeshStreamer<dtype,long long,SSSPVertex,SimpleMeshRouter > aggregator;
 */
...
class CkIndex_SSSPVertex:public CkIndex_ArrayElement{
  public:
    ...
    /* DECLS: threaded void process(const dtype &m);
     */
    // Entry point registration at startup
    
    static int reg_process_marshall4();
    // Entry point index lookup
    
    inline static int idx_process_marshall4() {
      static int epidx = reg_process_marshall4();
      return epidx;
    }

    
    inline static int idx_process(void (SSSPVertex::*)(const dtype &m) ) {
      return idx_process_marshall4();
    }


    
    static int process(const dtype &m) { return idx_process_marshall4(); }
    
    static void _call_process_marshall4(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_process_marshall4(void* impl_msg, void* impl_obj);
    
    static void _callthr_process_marshall4(CkThrCallArg *);
    
    static void _marshallmessagepup_process_marshall4(PUP::er &p,void *msg);
    /* DECLS: threaded void update(const dtype &m);
     */
    // Entry point registration at startup
    
    static int reg_update_marshall5();
    // Entry point index lookup
    
    inline static int idx_update_marshall5() {
      static int epidx = reg_update_marshall5();
      return epidx;
    }

    
    inline static int idx_update(void (SSSPVertex::*)(const dtype &m) ) {
      return idx_update_marshall5();
    }


    
    static int update(const dtype &m) { return idx_update_marshall5(); }
    
    static void _call_update_marshall5(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_update_marshall5(void* impl_msg, void* impl_obj);
    
    static void _callthr_update_marshall5(CkThrCallArg *);
    
    static void _marshallmessagepup_update_marshall5(PUP::er &p,void *msg);
    ...
    static int check(const double &w) { return idx_check_marshall8(); }
 ...
 */
    ...
    void process(const dtype &m, const CkEntryOptions *impl_e_opts=NULL) ;

/* DECLS: threaded void update(const dtype &m);
 */
    
    void update(const dtype &m, const CkEntryOptions *impl_e_opts=NULL) ;
...
class Closure_SSSPVertex {
  public:
    ...
    struct process_4_closure;


    struct update_5_closure;


    struct getScannedVertexNum_6_closure;


    struct verify_7_closure;


    struct check_8_closure;


    struct print_9_closure;
...
extern void _registertram_sssp(void);
