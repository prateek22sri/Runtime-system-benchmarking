...
double run_bfs(mpi_process_group &pg, Graph& g,	typename graph_traits<Graph>::vertex_descriptor current_source,
...
//-----------------------------------------	
	...
	for (unsigned int source_i = 0; source_i < num_sources; ++source_i) {
		...
		double bfs_time = run_bfs<Graph>(pg, g, current_source, n, verify);
