#ifndef _DECL_tram_multivertex_sssp_H_
#define _DECL_tram_multivertex_sssp_H_
#include "charm++.h"
#include "envelope.h"
#include <memory>
#include "sdag.h"
...
/* DECLS: readonly CProxy_ArrayMeshStreamer<dtype,long long,SSSPMultiVertex,SimpleMeshRouter > aggregator;
 */
...
class CkIndex_TestDriver:public CkIndex_Chare{
  public:
    ...
    /* DECLS: threaded void start(void);
     */
    // Entry point registration at startup
    ...
    static void _callthr_start_void(CkThrCallArg *);
    /* DECLS: threaded void restart(void);
     */
    // Entry point registration at startup
    ...
    static void _callthr_restart_void(CkThrCallArg *);
...
class CkIndex_SSSPMultiVertex:public CkIndex_ArrayElement{
  public:
    ...
    static int reg_check_marshall5();
    // Entry point index lookup
    
    inline static int idx_check_marshall5() {
      static int epidx = reg_check_marshall5();
      return epidx;
    }

    
    inline static int idx_check(void (SSSPMultiVertex::*)(const CmiUInt8 &v, const double &weight) ) {
      return idx_check_marshall5();
    }


    
    static int check(const CmiUInt8 &v, const double &weight) { return idx_check_marshall5(); }
    
    static void _call_check_marshall5(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_check_marshall5(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_check_marshall5(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_check_marshall5(PUP::er &p,void *msg);
    ...
    static int reg_foo_void();
    // Entry point index lookup
    
    inline static int idx_foo_void() {
      static int epidx = reg_foo_void();
      return epidx;
    }

    
    inline static int idx_foo(void (SSSPMultiVertex::*)(void) ) {
      return idx_foo_void();
    }


    
    static int foo(void) { return idx_foo_void(); }
    
    static void _call_foo_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_foo_void(void* impl_msg, void* impl_obj);
...
class Closure_SSSPMultiVertex {
  public:
    ...
    struct verify_4_closure;


    struct check_5_closure;


    struct getScannedVertexNum_6_closure;


    struct foo_7_closure;
...
extern void _registertram_multivertex_sssp(void);
