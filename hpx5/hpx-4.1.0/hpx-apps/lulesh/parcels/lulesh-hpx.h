...
typedef struct Domain {
  ...
  hpx_addr_t tracelock;

  int32_t reduceid;
  int32_t padding;
  hpx_addr_t allreduce;

  hpx_addr_t sbn1_recv;                         // recv gate for SBN1
  hpx_addr_t sbn3_recv[2];                      // recv gate for SBN3
  hpx_addr_t posvel_recv;                       // recv gate for PosVel
  hpx_addr_t monoq_recv;                        // recv gate for MonoQ

  hpx_addr_t sbn1_and;                          // finish all recvs for SBN1
  hpx_addr_t sbn3_and[2];                       // finish all recvs for SBN3
  hpx_addr_t posvel_and;                        // finish all recvs for PosVel
  hpx_addr_t monoq_and;                         // finish all recvs for MonoQ
...
void CHECK_AFFINITY(Domain *domain /*, int force */);
void CHECK_AFFINITY_SYNC(Domain *domain/*, int force */);
