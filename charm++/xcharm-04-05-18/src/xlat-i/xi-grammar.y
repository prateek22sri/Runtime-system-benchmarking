...
%type <uchare>		UChare UChareArray
...
Name		: IDENT
		...
		| UCHARE { ReservedWord(UCHARE); YYABORT; }
		| REENTRANT { ReservedWord(REENTRANT); YYABORT; }
		;
...
UChare		: UCHARE CAttribs NamedType OptBaseList MemberEList
		{ 
			//$$ = new Chare(lineno, $2|Chare::CCHARE, $3, $4, $5); 
...
UChareArray : UCHARE ARRAY ArrayIndexType ArrayAttribs NamedType OptBaseList MemberEList
		{  
		  //WARNING("'uchare array' construct found", @$.first_column, @$.last_column);
			//$$ = new UChareArray(lineno, $3, $2, $4, $5, $6); 
			$$ = new UChareArray(lineno, $4, $3, $5, $6, $7); 
      //YYABORT;
		}
		;
