...
class Member : public Construct {
 ...
 public:
  ...
  inline BaseChare *getContainer() const { return container; }
  virtual void setContainer(BaseChare *c) { container = c; }
  virtual void setChare(Chare *c);
  Chare *getChare() const;
	virtual void setUChare(UChare *c);
  ...
  virtual void lookforCEntry(CEntry *)  {}
	virtual void genBaseDecls(XStr& ) {} 
	virtual void genRegUnpack(XStr& ) {}
	virtual void genUChareProxyTriples(XStr& ) {}
	virtual void genUChareArrayWrappers(XStr&) {}
};
