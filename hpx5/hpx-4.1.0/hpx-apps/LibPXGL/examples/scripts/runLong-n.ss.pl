...
#  runs the ss solver on instances in the Long-n family

#  Usage: > perl runLong-n.ss.pl
# ============================================================================
...
$RESFILE   = "../results/Long-n.ss.res";
$PREFIX    = "$ARGV[0]/inputs/Long-n/Long-n";
$SOLVER    = "../sssp";
$GRAPH     = "$PREFIX.%s.%s.gr";
$AUX       = "$PREFIX.%s.%s.ss";
...
print   "* Long-n family ss core experiment\n";
