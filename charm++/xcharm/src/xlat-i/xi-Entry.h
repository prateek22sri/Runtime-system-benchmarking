...
#define SREENTRANT    0x100000 // <- reduction target
...
//    friend class CParsedFile;
  ...
  public:
    ...
    int getLine();
		...
		void genBaseDecls(XStr& str);
		void genRegUnpack(XStr& str);
		void genUChareProxyTriples(XStr& str);
		void genUChareArrayWrappers(XStr& str);
};
