...
class Parameter {
 public:
  ...
  public:
    ...
    void print(XStr &str,int withDefaultValues=0,int useConst=1, int useRef=1);
    void printAddress(XStr &str);
    void printValue(XStr &str);
		void printName(XStr &str);
    ...
    XStr* getAccelInstName(void);
		...
		public:
		void addValueToMessage(XStr &str);
		void getValueFromMessage(XStr &str);
};
...
class ParamList {
  ...
  public:
    ...
    void print(XStr &str,int withDefaultValues=0,int useConst=1, int useRef=1, char delim = ',');
    ...
    void checkParamList();
		void addAllValuesToMessage(XStr &str);
		void getAllValuesFromMessage(XStr &str);
};
