...
void Member::setChare(Chare *c) { container = c; }
Chare *Member::getChare() const  {return static_cast<Chare *>(container);}
void Member::setUChare(UChare *c) { container = c; }
...
InitCall::InitCall(int l, const char *n, int nodeCall)
	    : name(n)
{
	line=l; setContainer(0); isNodeCall=nodeCall;
