...
/* ---------------- method closures -------------- */
    ...
    struct Closure_SSSPMultiVertex::update_4_closure : public SDAG::Closure {
      CmiUInt8 v;
      double weight;
      CmiUInt8 parent;
    ...
    struct Closure_SSSPMultiVertex::verify_5_closure : public SDAG::Closure {
    ...
    struct Closure_SSSPMultiVertex::check_6_closure : public SDAG::Closure {
      CmiUInt8 v;
      double weight;
    ...
    struct Closure_SSSPMultiVertex::getScannedVertexNum_7_closure : public SDAG::Closure {
      

      getScannedVertexNum_7_closure() {
        init();
      }
      getScannedVertexNum_7_closure(CkMigrateMessage*) {
        init();
      }
            void pup(PUP::er& __p) {
        packClosure(__p);
      }
      virtual ~getScannedVertexNum_7_closure() {
      }
      PUPable_decl(SINGLE_ARG(getScannedVertexNum_7_closure));
    };
#endif /* CK_TEMPLATES_ONLY */
...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent);
 */

void CProxyElement_SSSPMultiVertex::update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent
  int impl_off=0;
  { //Find the size of the PUP'd data
    PUP::sizer implP;
    //Have to cast away const-ness to get pup routine
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_SSSPMultiVertex::idx_update_marshall4(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxyElement_SSSPMultiVertex::check(const CmiUInt8 &v, const double &weight, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckSend(impl_amsg, CkIndex_SSSPMultiVertex::idx_check_marshall6(),0);
}
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_SSSPMultiVertex::update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent
  int impl_off=0;
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_SSSPMultiVertex::idx_update_marshall4(),0);
}

// Entry point registration function

int CkIndex_SSSPMultiVertex::reg_update_marshall4() {
  int epidx = CkRegisterEp("update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent)",
...
void CkIndex_SSSPMultiVertex::_call_update_marshall4(void* impl_msg, void* impl_obj_void)
{
  SSSPMultiVertex* impl_obj = static_cast<SSSPMultiVertex *>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent*/
  PUP::fromMem implP(impl_buf);
  CmiUInt8 v; implP|v;
  ...
  impl_buf+=CK_ALIGN(implP.size(),16);
  /*Unmarshall arrays:*/
  impl_obj->update(v, weight, parent);
}

int CkIndex_SSSPMultiVertex::_callmarshall_update_marshall4(char* impl_buf, void* impl_obj_void) {
  SSSPMultiVertex* impl_obj = static_cast< SSSPMultiVertex *>(impl_obj_void);
  /*Unmarshall pup'd fields: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent*/
  PUP::fromMem implP(impl_buf);
  CmiUInt8 v; implP|v;
...
void CkIndex_SSSPMultiVertex::_marshallmessagepup_update_marshall4(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_SSSPMultiVertex::update_4_closure));
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_SSSPMultiVertex::verify_5_closure));
#endif /* CK_TEMPLATES_ONLY */
...
void CProxy_SSSPMultiVertex::check(const CmiUInt8 &v, const double &weight, const CkEntryOptions *impl_e_opts) 
{
  ...
  CkArrayMessage *impl_amsg=(CkArrayMessage *)impl_msg;
  impl_amsg->array_setIfNotThere(CkArray_IfNotThere_buffer);
  ckBroadcast(impl_amsg, CkIndex_SSSPMultiVertex::idx_check_marshall6(),0);
}

// Entry point registration function

int CkIndex_SSSPMultiVertex::reg_check_marshall6() {
  int epidx = CkRegisterEp("check(const CmiUInt8 &v, const double &weight)",
      _call_check_marshall6, CkMarshallMsg::__idx, __idx, 0+CK_EP_NOKEEP);
  CkRegisterMarshallUnpackFn(epidx, _callmarshall_check_marshall6);
  CkRegisterMessagePupFn(epidx, _marshallmessagepup_check_marshall6);

  return epidx;
}


void CkIndex_SSSPMultiVertex::_call_check_marshall6(void* impl_msg, void* impl_obj_void)
{
  SSSPMultiVertex* impl_obj = static_cast<SSSPMultiVertex *>(impl_obj_void);
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
...
int CkIndex_SSSPMultiVertex::_callmarshall_check_marshall6(char* impl_buf, void* impl_obj_void) {
  SSSPMultiVertex* impl_obj = static_cast< SSSPMultiVertex *>(impl_obj_void);
  /*Unmarshall pup'd fields: const CmiUInt8 &v, const double &weight*/
  PUP::fromMem implP(impl_buf);
  CmiUInt8 v; implP|v;
...
void CkIndex_SSSPMultiVertex::_marshallmessagepup_check_marshall6(PUP::er &implDestP,void *impl_msg) {
  CkMarshallMsg *impl_msg_typed=(CkMarshallMsg *)impl_msg;
  char *impl_buf=impl_msg_typed->msgBuf;
  /*Unmarshall pup'd fields: const CmiUInt8 &v, const double &weight*/
  PUP::fromMem implP(impl_buf);
...
PUPable_def(SINGLE_ARG(Closure_SSSPMultiVertex::check_6_closure));
#endif /* CK_TEMPLATES_ONLY */
...
PUPable_def(SINGLE_ARG(Closure_SSSPMultiVertex::getScannedVertexNum_7_closure));
#endif /* CK_TEMPLATES_ONLY */
...
void CProxySection_SSSPMultiVertex::update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent, const CkEntryOptions *impl_e_opts) 
{
  ckCheck();
  //Marshall: const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent
  int impl_off=0;
...
void CkIndex_SSSPMultiVertex::__register(const char *s, size_t size) {
  ...
  // REG: void update(const CmiUInt8 &v, const double &weight, const CmiUInt8 &parent);
...
#ifndef CK_TEMPLATES_ONLY
void _registercharm_multivertex_sssp(void)
{
...
extern "C" void CkRegisterMainModule(void) {
  _registercharm_multivertex_sssp();
}
#endif /* CK_TEMPLATES_ONLY */
#ifndef CK_TEMPLATES_ONLY
template <>
