...
$DIR     = "../inputs/Square-n";
$FORMAT  = "$DIR/Square-n.%s.%s.ss";


# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Random sources generator for the Square-n family\n";
...
for ( $p = $START; $p < $END + 1 ; $p++ ) { 
    ...
    print "\n>> Generating ss instances for data point [$str]\n";
    ...
    for ( $trial = 0; $trial < $TRIALS; ++$trial) {
        ...
        print FILE "c Square-n family ss problem instance\n";
        print FILE "c\n";
