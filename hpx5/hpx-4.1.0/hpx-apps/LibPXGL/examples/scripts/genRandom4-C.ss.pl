...
#  Last changed:   $Date: 2006/02/15 09:39:45 $
...
#  Random sources generator for the Random4-C family
#  Creates a suite of single-source shortest path
#  problem-specific auxiliary files.

#  Usage: > perl genRandom4-C.ss.pl
# ============================================================================
...
$FORMAT  = "$DIR/Random4-C.%s.%s.ss";


# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Random sources generator for the Random4-C family\n";
...
for ( $p = $START; $p < $END + 1 ; $p++ ) { 
    ...
    print "\n>> Generating ss instances for data point [n = 2^$NEXP, C = 4^$p]\n";
    ...
    for ( $trial = 0; $trial < $TRIALS; ++$trial) {
        ...
        print FILE "c Random4-C family ss problem instance\n";
        print FILE "c\n";
